...
export function LectureContent({ episode, moreEpisodes }: LectureContentProps) {
  ...
  return (
    <article className="w-full">
      ...
      {/* HERO SECTION */}
      {/* ============================================ */}
      <section className="bg-gradient-to-b from-forest-50 to-transparent px-4 py-8 sm:py-12 dark:from-ink-900">
        <div className="mx-auto max-w-3xl flex flex-col items-center text-center">
          {episode.scholar?.photo_url && (
            <div className="mb-6 w-20 h-20 rounded-full overflow-hidden border-4 border-forest-100 shadow-sm dark:border-ink-700">
              <Image
          ...
          <h1 className="text-3xl sm:text-4xl font-bold text-forest-900 leading-tight mb-3 dark:text-ink-100">
            {episode.title}
          </h1>
      ...
      {/* PLAYER CONTROLS */}
      {/* ============================================ */}
      <section className="px-4 py-6 border-b border-sand-200 bg-white dark:border-ink-700 dark:bg-ink-950">
      ...
      {/* ACTION BUTTONS */}
      {/* ============================================ */}
      <section className="px-4 py-6 bg-sand-50 dark:bg-ink-950">
      ...
      {episode.description && (
        <section className="px-4 py-8">
          <div className="mx-auto max-w-3xl">
            ...
            <div className="rounded-lg border border-sand-200 bg-sand-50 p-5 dark:border-ink-700 dark:bg-ink-900">
      ...
      {moreEpisodes.length > 0 && (
        <section className="px-4 py-8 border-t border-sand-200 dark:border-ink-700">
          <div className="mx-auto max-w-3xl">
