...
export function ScholarRow({ scholar, className }: ScholarRowProps) {
  return (
    <div
      className={cn(
        "flex items-center gap-3 rounded-lg px-2 py-2.5 transition-colors hover:bg-sand-100",
        className,
      )}
    >
      <Avatar
  ...
  return (
    <div className="flex items-center gap-3 rounded-lg px-2 py-2.5">
      ...
      <div className="flex-1 space-y-1.5">
        <div className="h-4 w-40 rounded bg-sand-200 animate-pulse" />
        <div className="flex items-center gap-1.5">
          <div className="h-5 w-12 rounded-full bg-sand-200 animate-pulse" />
          <div className="h-5 w-12 rounded-full bg-sand-200 animate-pulse" />
        </div>
      </div>
      <div className="h-4 w-4 bg-sand-200 rounded animate-pulse shrink-0" />
    </div>
  );
}
