    ...
    >
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 mt-0.5">
            <span className="text-xs text-forest-700">{episode.language}</span>
      ...
      {onDownload && (
        <button
          ...
          className="flex h-11 w-11 items-center justify-center rounded-full text-sand-300 hover:text-forest-700 hover:bg-forest-50 transition-colors shrink-0 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-forest-500"
...
export function EpisodeRowSkeleton({ index }: { index?: number }) {
  return (
    <div className="flex items-center gap-3 rounded-lg px-3 py-2.5">
      {index !== undefined && (
        <div className="h-4 w-6 rounded bg-sand-200 animate-pulse shrink-0" />
      )}
      <div className="flex-1 space-y-1.5">
        <div className="h-4 w-3/4 rounded bg-sand-200 animate-pulse" />
      ...
      <div className="h-3 w-10 rounded bg-sand-200 animate-pulse shrink-0" />
    </div>
  );
}
